...
#define RS24_MAXCH                      125U    // max. chanel number x 1 MHz 2,4GHz...2,525GHz
#define RF24_CHANEL                     20U     // raadio chanel for this network
#define RF24_RX_ADDR				    "LuxT1" // receiving radio address
#define RF24_TX_ADDR		            "LuxRF" // network controller radio address
/* Interrupt masks */
...
{
	RF24_TxStaLost = 0x00,   /*!< Message is lost, reached maximum number of retransmissions */
	RF24_TxStaOk = 0x01,     /*!< Message sent successfully */
	RF24_TxStaSending = 0xFF /*!< Message is still sending */
