...
const char parstag[40][5] =
{   "RTsta", "RTmod", "BTdnd", "BThmd", "BTsos", "SPset", "SPmin", "SPmax", "CLmax", "HTmin",        // command parser
    "FNmod", "FNdif", "FNlow", "FNmid", "OWifa", "OWgra", "OWbca", "RSifa", "RSgra", "RSbca",        // room thermostat parameter list
